export const portfolioData = {
  personal: {
    ...
    summary:
      "Experienced Robotics Engineer specializing in autonomous navigation, SLAM, and Vision-Language-Action models for humanoid and mobile robots. Strong background in ROS2, sensor fusion, and real-time systems with publications at ICRA and IRCE conferences.",
  },
  ...
  publications: [
    ...
    },
    {
      ...
      venue:
        "International Conference on Intelligent Robotics and Control Engineering (IRCE)",
      year: "2023",
      type: "Conference",
  ...
  projects: [
    {
      ...
      description:
        "End-to-end VLA pipeline from data collection to model deployment for bimanual mobile manipulation.",
    ...
    },
    {
      ...
      description:
        "Developed a VTOL tilt-rotor aircraft with ROS2-based autonomy flight stack leveraging ArduPilot.",
    ...
    },
    {
      ...
      description:
        "Real-time tracking and trajectory prediction using 2D LiDAR for autonomous collision avoidance. Validated through industrial tests.",
    ...
    },
    {
      ...
      description:
        "Comprehensive autonomous landing using Behavior Trees and Twin Delayed DDPG (TD3) for adaptive response.",
    ...
    },
    {
      ...
      description:
        "Dynamic formation control algorithms for multi-robot systems with adaptive formations based on environmental cues.",
    ...
    },
    {
      title: "Pose EKF SLAM",
      description:
        "Extended Kalman Filter based SLAM with pose graph optimization for reduced computational demands.",
    ...
    },
    {
      ...
      description:
        "Designed humanoid robot for RoboCup with locomotion, ball detection, and strategic decision-making algorithms.",
  ...
  demos: [
    // {
    //   title: "VLA Model: Bimanual Pick and Place",
    //   description: "End-to-end demonstration of a Vision-Language-Action model performing bimanual manipulation tasks on the MIPA platform.",
    //   videoUrl: "https://www.youtube.com/watch?v=REPLACE_WITH_VIDEO_ID",
    //   tags: ["VLA", "Isaac Lab", "Gr00t"]
    // },
    // {
    //   title: "Multi-Robot Collision Avoidance",
    //   description: "Real-time multi-object tracking with predictive collision avoidance using 2D LiDAR in an industrial setting.",
    //   videoUrl: "https://www.youtube.com/watch?v=REPLACE_WITH_VIDEO_ID",
    //   tags: ["LiDAR", "Tracking", "MPC"]
    // }
  ],
};
